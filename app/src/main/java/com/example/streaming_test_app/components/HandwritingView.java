package com.example.streaming_test_app.components;
...
import com.example.streaming_test_app.model.DrawingBitmap;
import com.example.streaming_test_app.model.DrawingPath;

import com.example.streaming_test_app.model.FileUploadResponse;
import com.example.streaming_test_app.services.FileUploaderService;
import com.example.streaming_test_app.utils.DrawingUtils;
import com.example.streaming_test_app.utils.DrawingWebSocketClient;
            ...
            webSocketClient = new DrawingWebSocketClient(BuildConfig.SOCKET_ADDRESS, new DrawingWebSocketClient.MessageListener() {
                ...
                public void onImageDragged(String message) {
                    try {
                        ...
                        imageUrl = BuildConfig.BASE_URL+"/file/getFile/"+imageUrl;
                        if (!isAdmin){
